...
import CFSLog from './components/HoCs/CFSLog';
...
const tmpCFSLog = () => (
  <div>
    <Switch>
      <Route exact path="/CFSLog" component={() => (<div>sfsd</div>)} />
...
const App = () => (
  <div>
    <header>
      ...
      <Link to="/CFSLog">CFSLog </Link>
      <Link to="/roster">Roster </Link>
      <Link to="/CFS">CFS </Link>
    </header>
    <main>
      <Route exact path="/" component={() => (<div>UnderConstruction</div>)} />
      <Route path="/Counter" component={Counter} />
      <Route path="/About" component={About} />
      <Route path="/Scientist" component={Scientist} />
      <Route path="/CFSLog" component={tmpCFSLog} />
    </main>
  </div>
);
