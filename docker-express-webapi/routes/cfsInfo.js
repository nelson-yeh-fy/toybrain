...
const MONGODB_COLLECTION_CFSINFO = 'cfsInfo';
...
router.route('/')
    ...
    .get(function (req, res, next) {
        ...
        dbHelper.findAll(req, res, MONGODB_COLLECTION_CFSINFO);
    })

    // create an item (accessed at POST http://localhost:3001/api/<route>)
    .post(function (req, res) {

        dbHelper.addItem(req, res, MONGODB_COLLECTION_CFSINFO);
    })
    ;
...
router.route('/:id')
    ...
    .get(function (req, res) {
        dbHelper.findById(req, res, MONGODB_COLLECTION_CFSINFO);
    })

    // update item with this id (accessed at PUT http://localhost:3001/api/<route>/:idx)
    .put(function (req, res) {
        dbHelper.updateItem(req, res, MONGODB_COLLECTION_CFSINFO);
    })

    // delete item with this id (accessed at DELETE http://localhost:3001/api/<route>/:id)
    .delete(function (req, res) {
        dbHelper.deleteItem(req, res, MONGODB_COLLECTION_CFSINFO);
    })
    ;
